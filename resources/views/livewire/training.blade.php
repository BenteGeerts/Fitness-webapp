        ...
        <div class="col-md-12 col-lg-9 col-xl-10">
            ...
            @if($showTraining)
                <div class="training__programs">
                    ...
                    <h2 class="h3" style="margin-bottom:12px;">Recommended</h2>
                    ...
                    <h3 class="h3" style="margin-top:24px; margin-bottom:12px;">All programs</h3>
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <a class="program__button" href="{{ route('training.new') }}">
                                        <div class="program__button-text">
                                            <span>+</span><span style="font-size:1rem; padding-left:8px;">New program</span>
                                        </div>
                                    </a>
                                </div>
                            @endif
            ...
            @if($showHistory)
                <div class="training__calendar">
                    <input wire:model="dateInput" wire:change.debounce="showExercises"
                           ...
                           style="background:transparent; border:none; color:#CAFF00; font-weight:600; cursor:pointer;">
                </div>
                ...
                <div class="training__programs">
                    ...
                    <div class="training__stats-wrapper">
                        <div class="training__stats">
                            <div><i class="icon-weight training__stats-icon" style="color:#4F8EF7;"></i></div>
                            <div>
                                <b>{{ $this->getWeight() }}kg</b>
                                <p style="color:#8B8BA8; font-size:0.8125rem;">Lifted</p>
                            </div>
                        </div>
                        <div class="training__stats">
                            <div><i class="icon-360 training__stats-icon" style="color:#39D98A;"></i></div>
                            <div>
                                <b>{{ $this->getReps() }}</b>
                                <p style="color:#8B8BA8; font-size:0.8125rem;">Reps</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-md-between justify-content-xl-start">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4">
                                <div class="training__history">
                                    ...
                                    @foreach ($exercise as $i => $set)
                                        <div class="training__set-row" style="border-bottom: 1px solid rgba(255,255,255,0.06);">
                        ...
                        @empty
                            <div class="col-12" style="text-align:center; padding: 48px 0;">
                                <i class="icon-training" style="font-size:3rem; color:#52526A; display:block; margin-bottom:12px;"></i>
