<div>
    ...
    @if($modalOne)
        <div class="profile__modal">
            <p class="profile__modal-text">This user currently did <b>{{$currentTrainings}} trainings</b>, this user needs to do <b>1 training</b> to unlock this badge!</p>
    ...
    @if($modalTwo)
        <div class="profile__modal">
            <p class="profile__modal-text">This user currently did <b>{{$currentTrainings}} trainings</b>, this user needs to do <b>100 trainings</b> to unlock this badge!</p>
    ...
    @if($modalThree)
        <div class="profile__modal">
            <p class="profile__modal-text">This user currently earned <b>{{$currentDiamonds}} diamonds</b>, this user needs to have <b>10 000 diamonds</b> to unlock this badge!</p>
    ...
    @if($modalFour)
        <div class="profile__modal">
            <p class="profile__modal-text">This user currently has <b>{{$currentFriends}} friends</b>, this user needs to have <b>1 friend</b> to unlock this badge!</p>
